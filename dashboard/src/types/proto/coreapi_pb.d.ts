...
export class CreateBlockRequest extends jspb.Message {
  ...
  clearRunconfig(): void;
  getRunconfig(): models_pb.RunConfig | undefined;
  setRunconfig(value?: models_pb.RunConfig): void;
...
export namespace CreateBlockRequest {
  export type AsObject = {
    envid: string,
    name: string,
    runconfig?: models_pb.RunConfig.AsObject,
...
export class UpdateBuildStatusRequest extends jspb.Message {
  ...
  hasStatus(): boolean;
  clearStatus(): void;
  getStatus(): models_pb.BuildStatus | undefined;
  setStatus(value?: models_pb.BuildStatus): void;
...
export namespace UpdateBuildStatusRequest {
  export type AsObject = {
    ...
    envid: string,
    releaseid: string,
    status?: models_pb.BuildStatus.AsObject,
  }
}
...
export class CustomDomainNameRequest extends jspb.Message {
  ...
  getProtocol(): models_pb.RunConfig.ProtocolMap[keyof models_pb.RunConfig.ProtocolMap];
  setProtocol(value: models_pb.RunConfig.ProtocolMap[keyof models_pb.RunConfig.ProtocolMap]): void;
...
export namespace CustomDomainNameRequest {
  export type AsObject = {
    ...
    cname: string,
    protocol: models_pb.RunConfig.ProtocolMap[keyof models_pb.RunConfig.ProtocolMap],
  }
}
...
export class TeleportResponse extends jspb.Message {
  hasData(): boolean;
  clearData(): void;
  getData(): models_pb.TeleportServiceData | undefined;
  setData(value?: models_pb.TeleportServiceData): void;
...
export namespace TeleportResponse {
  export type AsObject = {
    data?: models_pb.TeleportServiceData.AsObject,
  }
}
...
export class GenReleaseConfigFromKintoFileRepoRequest extends jspb.Message {
  getBlocktype(): models_pb.Block.TypeMap[keyof models_pb.Block.TypeMap];
  setBlocktype(value: models_pb.Block.TypeMap[keyof models_pb.Block.TypeMap]): void;
...
export namespace GenReleaseConfigFromKintoFileRepoRequest {
  export type AsObject = {
    blocktype: models_pb.Block.TypeMap[keyof models_pb.Block.TypeMap],
    org: string,
    repo: string,
    branch: string,
    envid: string,
